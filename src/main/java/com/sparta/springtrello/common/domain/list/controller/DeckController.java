package com.sparta.springtrello.common.domain.list.controller;

import com.sparta.springtrello.common.domain.list.dto.request.*;
import com.sparta.springtrello.common.domain.list.dto.response.DeckCreateResponse;
import com.sparta.springtrello.common.domain.list.service.DeckService;
...
public class DeckController {
    ...
    public ResponseEntity<DeckCreateResponse> createList(
            @PathVariable(name = "boardId") Long boardId,
            @RequestBody String listName
                                                        ) {
        return ResponseEntity
                .status(200)
                .body(this.deckService.createList(boardId, listName));
    }
    ...
    public ResponseEntity<Page<DeckCreateResponse>> getLists(DeckFindAllRequest request) {
        return ResponseEntity
                .status(200)
                .body(this.deckService.getLists(request));
    }
    ...
    public ResponseEntity<DeckCreateResponse> moveList(
            @PathVariable(name = "boardId") Long boardId,
            @PathVariable(name = "newOrder") int newOrder
    ) {
        return ResponseEntity
                .status(200)
                .body(this.deckService.moveList(boardId, newOrder));
    }
    ...
    public ResponseEntity<DeckCreateResponse> updateList(
            @PathVariable(name = "listId") Long listId,
            @RequestBody String listName
    ) {
        return ResponseEntity
                .status(200)
                .body(this.deckService.updateList(listId, listName));
    }
    ...
    public ResponseEntity<Void> deleteList(@RequestParam(name = "listId") Long listId) {
