...
public class MemberController {
    ...
    public ResponseEntity<ApiResponse<MemberResponseDto>> inviteUser(
    ...
    public ResponseEntity<ApiResponse<MemberResponseDto>> acceptWorkspace(
    ...
    public ResponseEntity<ApiResponse<MemberResponseDto>> changeRole(
            @AuthenticationPrincipal AuthUser authUser,
            @PathVariable Long memberId,
