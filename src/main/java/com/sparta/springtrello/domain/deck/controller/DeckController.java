...
import com.sparta.springtrello.annotation.RoleMember;
import com.sparta.springtrello.annotation.RoleOverReadOnly;
...
public class DeckController {
     ...
     */
    @RoleOverReadOnly
    @PutMapping("/workspaces/{workspaceId}/boards/{boardId}/decks/{deckId}/orders/{newOrder}")
    public ResponseEntity<ApiResponse<DeckResponse>> moveDeck(
            @PathVariable(name = "workspaceId") Long workspaceId,
            DeckMoveRequest request
    ) {
        return ResponseEntity
                .status(200)
                .body(
     ...
     */
    @RoleOverReadOnly
    @PutMapping("/workspaces/{workspaceId}/boards/{boardId}/decks/{deckId}")
     ...
     */
    @RoleOverReadOnly
    @DeleteMapping("/workspaces/{workspaceId}/boards/{boardId}/decks/{deckId}")
